...
if (insert == true)
{
    ...
    if ((penis_grab == true && mouse_check_button_pressed(mb_left) && (sex_progress > 0 || orgasm == true)) || (sex_progress >= round(sex_progress_max * 0.75) && ds_list_find_index(pill_effects_active, UnknownEnum.Value_15) != -1 && edge_boost < 10))
    {
        ...
        if (sex_progress >= (sex_progress_max * 0.6) && edge_boost < max_edge)
        {
            ...
            if (ds_list_find_index(pill_effects_active, UnknownEnum.Value_15) != -1 && ball_size < 1.3)
            {
                ball_size += 0.05;
                balls_jiggle = 0.2;
            }
...
thrust_prev = thrust;
womb_size = median(1, womb_size, 3);
if (insert == true)
{
...
if (thrust > 0.95 && loads < max_loads)
{
    if (insert == false)
    {
        womb_size = median(1, fill_amount / fill_max, 3);
...
if (insert == true && xray == true && bottom_enable_xray == true && title == false && start_timer < 1 && sex_position != 2)
{
    ...
    var xray_size = 2 - (max(0, womb_size - 1) * 0.5);
...
if (insert == false && ds_list_find_index(pill_effects_active, UnknownEnum.Value_12) == -1)
{
...
if (title_scale > 0.01)
{
    ...
    var version_string = "";
    var modded = false;
    version_string = "Wife's Bedroom: Apex Refined MOD v4.1";
