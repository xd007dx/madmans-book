...
ScriptMessage("=== APPLYING CLEAN MASTER V10 (APEX REFINED MOD v4.1, FONT AUTO-SWAP, DIALOGUE DUAL-LANG) ===");
...
// =============================================================
// 1. Create_0: Limits 3x, Rating 10x, Lang Array Fix, TTF Fonts & Auto-Swap
// =============================================================
ScriptMessage("[1/4] Patching Create_0 max limits, rating 10x, TTF fonts & dual-language dialogue system...");
...
global.loaded_ttf_big = 100663296;
global.loaded_ttf_handwriting = 100663297;
global.loaded_ttf_small = 100663298;
...
global.custom_font_big = global.orig_font_big;
global.custom_font_handwriting = global.orig_font_handwriting;
global.custom_font_small = global.orig_font_small;
...
// =============================================================
// 3. Draw_0: Submenu, Title MOD Name, Dual-Language Dialogue Switch & UI Guard
// =============================================================
ScriptMessage("[3/4] Patching Draw_0 with Title MOD name, Dialogue switch & UI guard...");
...
// Language select: Close submenu, update active fonts, update dialogue files
...
ScriptMessage("=== CLEAN MASTER V10 APPLIED SUCCESSFULLY! ===");
