...
ScriptMessage("=== APPLYING CLEAN MASTER V11 (SAFE LANG LOAD, BYTECODE FONT HOOK, PERSISTENT LANG) ===");
...
// =============================================================
// 1. Create_0: Limits 3x, Rating 10x, Lang Array Fix, TTF Fonts & Persistent Lang
// =============================================================
...
ScriptMessage("=== CLEAN MASTER V11 APPLIED SUCCESSFULLY! ===");
